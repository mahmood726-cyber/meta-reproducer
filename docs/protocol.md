        # Meta Reproducer: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/meta-reproducer.git

        ## Objective

        MetaReproducer provides automated reproduction pipelines for published meta-analyses, verifying statistical results against original data and flagging discrepancies.
        ...
        - Code: https://github.com/mahmood726-cyber/meta-reproducer.git
        - Dashboard: https://mahmood726-cyber.github.io/meta-reproducer/
